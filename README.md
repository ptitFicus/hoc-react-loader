...
### Wait as a function
The `print` parameter can also be a function. Then the `props` and `context` are given to it (in this order), and it should a boolean indicating wether or not the actual component should be displayed.
